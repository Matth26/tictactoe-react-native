...
class Board extends Component {
  ...
  getSymbol(rowIndex, position, symbol) {
    ...
    return <EmptyCell key={position} addSymbol={this.addSymbol.bind(this, rowIndex, position)} turn={this.props.turn} />;
  }
  ...
  displayResults(won, draw) {
    if(won) return (
        <View><Text>Win !</Text></View>
    );
    else if (draw) return (
        <View><Text>Draw !</Text></View>
    )
  }
